...
import com.p2p.bawei.p2pinvest1801.util.DensityUtils;
...
public class PColumn extends View {
    ...
    public PColumn(Context context,  AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initPaint();
    }

    public PColumn(Context context,  AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        ...
        mColor = mContext.getResources().getColor(R.color.zhu);
