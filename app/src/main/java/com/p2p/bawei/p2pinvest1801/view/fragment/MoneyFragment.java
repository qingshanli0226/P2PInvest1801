...
public class MoneyFragment extends BaseFragment<MyAllPresenter> implements MyAllContract.View {
    ...
    private void initTab() {
        list_fragment.add(new MyFragment_1());
        list_fragment.add(new MyFragment_2());
        list_fragment.add(new MyFragment_3());
        list_string.add("全部理财");
        list_string.add("推荐理财");
        list_string.add("热门理财");

        myFragmentAdapter = new MyFragmentAdapter(getFragmentManager(),list_fragment,list_string);
