...
public class RegisterModel extends BaseModel implements RegisterContract.IRegisterContractModel {
    @Override
    public void getRegister(String name, String pwd,Observer<StringBean> observer) {
...
//        map.put("password", pwd);
        ...
        NetRetrofitManager.getInstance()
                .getRetrofit()
                .create(Api.class)
                .registerBeans(encryptedMap)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(observer);
    }

//    public void register(String name, String pwd,Observer<StringBean> observer) {
//
//
//    }
}
