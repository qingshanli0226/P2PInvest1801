...
public class MyLineChartDemoView extends View {
    ...
    public MyLineChartDemoView(Context context) {
        super(context);
        initPaint();
    }

    public MyLineChartDemoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public MyLineChartDemoView(Context context, AttributeSet attrs, int defStyleAttr) {
