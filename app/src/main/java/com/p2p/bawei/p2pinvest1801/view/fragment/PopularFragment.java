...
public class PopularFragment extends BaseFragment<MyAllPresenter> implements MyAllContract.View {
    ...
    public void initAdapter(MyAllBean myAllBean) {
        ...
        flowLayout.setAdapter(new FlowAdapter(list_name) {
            ...
            public View getView(int i) {
                ...
                View inflate = LayoutInflater.from(getActivity()).inflate(R.layout.layout_item_fragment_recommend, null);
