...
//        }
    ...
    //实现生成json的信息摘要（签名)
    public static String encryptJsonByMd5(JSONObject jParams) throws JSONException {
    ...
    public static void encryptJsonByBase64(JSONObject jParams) throws JSONException {
        Iterator<String> iterator = jParams.keySet().iterator();
