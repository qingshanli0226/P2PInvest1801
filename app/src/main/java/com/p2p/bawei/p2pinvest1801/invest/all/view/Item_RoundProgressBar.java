 ...
 * 圆形进度条
 */
public class Item_RoundProgressBar extends View {
    //绘制矩形区域
    private RectF rectF;
    //起始角度
    ...
    public Item_RoundProgressBar(Context context) {
        super(context);
        initData();
    }

    public Item_RoundProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#28baed"));
